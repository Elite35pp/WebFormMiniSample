<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountingList.aspx.cs" Inherits="homework.SystemAdmin.AccountingList" %>
    ...
    <form id="form1" runat="server">
        <table>
            ...
            <tr>
                ...
                <td>
                    <!--這裡放主要內容-->
                    <asp:Button ID="btnCreate" runat="server" Text="新增流水帳" OnClick="btnCreate_Click" />

                    <asp:GridView ID="gvAccountingList" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvAccountingList_RowDataBound" CellPadding="4" ForeColor="#333333" GridLines="None" style="margin-right: 0px">
                    ...
                    <asp:PlaceHolder ID="plcNodate" runat="server" Visible="false">
                        <p style="color: hotpink; background-color: beige">
                            你的流水帳沒有資料
                        </p>
                    </asp:PlaceHolder>
